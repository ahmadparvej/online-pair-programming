...
const Chatroom = () => {
    ...
    return (
        <div className="py-4 w-100 shadow bg-white text-dark border rounded container" >
                <div className="text-center px-3 mb-4 text-capitalize">
                    <h1 className="text-warning mb-4">{data?.name} Chat Room</h1>
                </div>
                <div className="bg-light border rounded p-3 mb-4" style={{height: "400px", overflowY:"scroll"}}>
                    {
                        allMessages.map(msg => {
